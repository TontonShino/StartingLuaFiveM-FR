...
```lua
--[[
NB que pour la déclaration d'une fonction dans une table il faut la mettre entre crochet'
]]--
tableFonction =
{
...
Commentaires Maeen:La différence entre un seul point et deux points quand on appelle une méthode, c'est que quand tu appelles une méthode avec un seul point, rien de bizarre
...
NIL:Le nil (type) est une valeur vide
...
Sources: OpenClassroom, luteuz.biz et le site officiel du Lua.